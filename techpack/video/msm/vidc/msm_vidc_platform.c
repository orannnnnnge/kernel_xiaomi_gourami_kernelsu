...
static struct msm_vidc_codec_capability kona_capabilities[] = {
	/* {cap_type, domains, codecs, min, max, step_size, default_value,} */
	{CAP_FRAME_WIDTH, DEC, CODECS_ALL, 128, 8192, 1, 1920},
	{CAP_FRAME_HEIGHT, DEC, CODECS_ALL, 128, 8192, 1, 1080},
	...
	/* VP8 specific */
	{CAP_FRAME_WIDTH, DEC, VP8, 128, 4096, 1, 1920},
	{CAP_FRAME_HEIGHT, DEC, VP8, 128, 4096, 1, 1080},
	{CAP_FRAME_WIDTH, ENC, VP8, 128, 4096, 2, 1920},
	{CAP_FRAME_HEIGHT, ENC, VP8, 128, 4096, 2, 1080},
	/* (4096 * 2304) / 256 */
	...
	/* Secure usecase specific */
	{CAP_SECURE_FRAME_WIDTH, DEC, CODECS_ALL, 128, 4096, 1, 1920},
	{CAP_SECURE_FRAME_HEIGHT, DEC, CODECS_ALL, 128, 4096, 1, 1080},
